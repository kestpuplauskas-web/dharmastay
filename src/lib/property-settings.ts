...
export const settingsSchemas = {
  ...
  notifications: z.object({
    ...
    notifyCheckoutReminder: z.boolean(),
    notifyPaymentReminder: z.boolean(),
...
export const SETTINGS_COLUMN_MAP: Record<keyof PropertySettings, string> = {
  ...
  notifyCheckoutReminder: "notify_checkout_reminder",
  notifyPaymentReminder: "notify_payment_reminder",
...
export const SETTINGS_SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "notifyCheckoutReminder", label: "Išvykimo priminimas", type: "switch", colSpan: 2 },
      { name: "notifyPaymentReminder", label: "Mokėjimo priminimas", type: "switch", colSpan: 2 },
